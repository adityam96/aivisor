          ...
          <div className="mb-6 bg-blue-50 border border-blue-200 rounded-md p-4">
            <div className="flex">
              ...
              <div className="ml-3 flex-1 md:flex md:justify-between">
                <p className="text-sm text-blue-700">Are you a creator or company building AI tools?</p>
                <p className="mt-3 text-sm md:mt-0 md:ml-6">
                  <Link to="/register?creator=true" className="whitespace-nowrap font-medium text-blue-700 hover:text-blue-600">
                    Creator Sign Up <span aria-hidden="true">&rarr;</span>
                  </Link>
                </p>
              </div>
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="flex">
                <input
                  ...
                  className="appearance-none flex-1 block w-full px-3 py-2 border border-gray-300 rounded-l-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                />
                <button
                  type="button"
